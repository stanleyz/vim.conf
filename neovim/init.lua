...
map('n', '<leader>gll', ':Git ll<CR>', options)
map('n', '<leader>gdf1', ':Gvdiffsplit HEAD~1<CR>', options)
map('n', '<leader>gdfm', ':Gvdiffsplit origin/main...HEAD<CR>', options)
map('n', '<leader>gdff', ':Gvdiffsplit ', options)
map('n', '<leader>gdfv', ':DiffviewOpen<CR>', options)
map('n', '<leader>gdfh', ':DiffviewFileHistory<CR>', options)
